...
Hackathon winners - Team Coding Rookie
...
Alternatively, open Data_Hackathon_Analysis.ipynb in Google Colab or Jupyter and run all cells sequentially, then run predictive_model.py.
